...
public class Order02Controller {
    ...
    public String createOrder() throws Exception {
        ...
        String currentPath = zooKeeper
            .create(this.path + this.node, null, ZooDefs.Ids.OPEN_ACL_UNSAFE, CreateMode.EPHEMERAL_SEQUENTIAL);
    ...
    public void waitLock(String currentPath) {
        try {
            ...
            if (index > 0) {
                ...
                //对前一个节点绑定节点删除事件
                zooKeeper.getData(path + "/" + preNode, event -> {//前一个节点删除
